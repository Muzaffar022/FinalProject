...
from apps.telegrambot.keyboards import replies
from apps.telegrambot import States
from apps.telegrambot.models import TelegramModel
from apps.telegrambot.keyboards.replies import get_contact_button
    ...
    if update.message and update.message.text:
        ...
        if re.match("^(0[1-9]|[12][0-9]|3[01])\.(0[1-9]|1[0-2])\.(199[6-9]|20[0-9]{2})$", text):
            try:
                ...
                pinf = update.message.text
                gender = update.message.text
                update.message.reply_text(f"Your Information save "
